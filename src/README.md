...
The next authorized slice is Repository Inspector V0 only. Define its public input/output, budgets, failure model and fixtures before writing code. Do not create empty implementation packages or scaffold the entire pipeline just to mirror this conceptual list.
